...
//        shortcutIntent.setClassName(this, this.getClass().getName());
        shortcutIntent.setClassName(this, "jp.kivajapan.rssreader.RssReaderActivity");
        ...
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, getString(R.string.list));
        Parcelable iconResource = Intent.ShortcutIconResource.fromContext(
                this,  R.drawable.kiva_icon);
